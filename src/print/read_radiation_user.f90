SUBROUTINE READ_RADIATION_USER

! ---------------------------------------------------------------------------- !
!                                                                              !
!    READ_RADIATION_USER - ROUTINE TO READ USER INPUT OF PROG PRINT_RADIATION. !
!                                                                              !
...
IF (IOS.EQ.0) THEN
   ...
   ELSE
      WRITE (IU06,*) ' ++++++++++++++++++++++++++++++++++++++++++++++++++++'
      WRITE (IU06,*) ' +                                                  +'
      WRITE (IU06,*) ' +     INFORMATION FROM SUB. READ_RADIATION_USER    +'
      WRITE (IU06,*) ' +     ====================================         +'
      WRITE (IU06,*) ' +                                                  +'
      WRITE (IU06,*) ' + THE RADIATION USER FILE COULD BE OPENED.         +'
      WRITE (IU06,*) ' + BUT DOES NOT CONTAIN THE PRINT NAMELIST.         +'
      WRITE (IU06,*) ' + RADIATION USER FILE NAME IS FILE05 = ', TRIM(FILE05)
...
ELSE
   WRITE (IU06,*) ' ++++++++++++++++++++++++++++++++++++++++++++++++++++'
   WRITE (IU06,*) ' +                                                  +'
   WRITE (IU06,*) ' +     INFORMATION FROM SUB. READS_RADIATION_USER   +'
   WRITE (IU06,*) ' +     ==========================================   +'
   WRITE (IU06,*) ' +                                                  +'
   WRITE (IU06,*) ' + THE RADIATION USER FILE COULD NOT BE OPENED.     +'
   WRITE (IU06,*) ' + RADIATION USER FILE NAME IS FILE05 = ', TRIM(FILE05)
   WRITE (IU06,*) ' +         UNIT IS         IU05 = ', IU05
   WRITE (IU06,*) ' +                                                  +'
...
IF (I.GT.MOUTT) THEN
   WRITE(IU06,*) '+++++++++++++++++++++++++++++++++++++++++++++++++'
   WRITE(IU06,*) '+                                               +'
   WRITE(IU06,*) '+   WARNING ERROR IN SUB. READ_RADIATION_USER   +'
   WRITE(IU06,*) '+   =========================================   +'
   WRITE(IU06,*) '+                                               +'
...
DO I= 1,NOUT_R,2
   CALL F_NEW_DATA
   CFLAG_R(  I) = .NOT. (LINE( 2: 2).EQ.'N' .OR. LINE( 2: 2).EQ.'n')
   CFLAG_R(I+1) = .NOT. (LINE(38:38).EQ.'N' .OR. LINE(38:38).EQ.'n')
END DO

! ---------------------------------------------------------------------------- !
!                                                                              !
!     6. MODEL OUTPUT SELECTION.                                               !
!        -----------------------                                               !

CALL F_NEW_DATA
REGULAR = .NOT.(SCAN(LINE( 2:11),'N').GT.0 .OR. SCAN(LINE( 2:11),'n').GT.0)


! ---------------------------------------------------------------------------- !
!                                                                              !
!     7. FIRST INPUT DATE AND INCREMENT.                                       !
!        -------------------------------                                       !
...
! ---------------------------------------------------------------------------- !
!                                                                              !
!     9. TRANSFER DATA TO WAM_PRINT_MODULE.                                    !
!        ----------------------------------                                    !
...
!                                                                              !
   ...
   DO WHILE (LINE(1:1).EQ.'C' .OR. LINE(1:1).EQ.'c')
      ...
      WRITE(IU06,*) ' **********************************************'
      WRITE(IU06,*) ' *                                            *'
      WRITE(IU06,*) ' *   FATAL ERROR IN SUB. READ_RADIATION_USER  *'
      WRITE(IU06,*) ' *   =======================================  *'
...
END SUBROUTINE READ_RADIATION_USER
